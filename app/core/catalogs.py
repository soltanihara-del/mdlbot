...
SETTINGS: tuple[SettingDefinition, ...] = (
    ...
    _setting("media.probe_timeout", "media", "duration", 30, "Media probe timeout", "مهلت بررسی رسانه", unit="seconds", minimum=5, maximum=300),
    _setting("media.process_timeout", "media", "duration", 3600, "Media processing timeout", "مهلت پردازش رسانه", unit="seconds", minimum=60, maximum=21600),
    _setting("media.transcode_enabled", "media", "boolean", True, "Media transcoding", "تبدیل رسانه"),
    _setting("media.hls_enabled", "media", "boolean", True, "HLS generation", "تولید HLS"),
    _setting("media.hls_segment_seconds", "media", "integer", 6, "HLS segment duration", "مدت قطعه HLS", unit="seconds", minimum=2, maximum=20),
