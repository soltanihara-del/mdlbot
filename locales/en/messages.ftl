...
job-failed = Processing failed after { $bytes }.
progress-stage-downloading = Downloading
progress-stage-downloaded = Download received
progress-stage-receiving = Receiving from Telegram
progress-stage-scanning = Security scan
progress-stage-processing = Processing
progress-stage-generating_link = Creating link
progress-stage-uploading = Sending to Telegram
progress-stage-uploaded = Sent to Telegram
